    ...
    <footer className="bg-navy-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3 mt-5">
              ...
              {["Facebook", "Instagram"].map((sn) => (
                ...
                >
                  <svg className="w-4 h-4 text-navy-300" fill="currentColor" viewBox="0 0 24 24">
                    {sn === "Facebook" ? (
          ...
          {/* Links */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-widest text-navy-400 mb-4">
              Navegación
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-navy-300">
              ...
              <li className="flex justify-between gap-4">
                <span>Domingo</span>
                <span className="text-white font-medium">Urgencias</span>
              </li>
            </ul>
